...
namespace WaitersOnCall {
	...
	/// <summary>
	/// Summary for DeleteDriver
	/// </summary>
	public ref class DeleteDriver : public System::Windows::Forms::Form
	{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panelAddDriver->Controls->Add(this->btnDelete);
			...
			this->panelAddDriver->Size = System::Drawing::Size(1267, 618);
			this->panelAddDriver->TabIndex = 3;
			this->panelAddDriver->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &DeleteDriver::panelAddDriver_Paint);
			// 
			// lbNavigation
			// 
			...
			this->lbNavigation->Text = L"Home Page  |  Driver > Delete Driver";
			...
			this->btnCancel->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnCancel->Location = System::Drawing::Point(26, 506);
			...
			this->btnCancel->Click += gcnew System::EventHandler(this, &DeleteDriver::btnCancel_Click);
			// 
			// btnDelete
			// 
			...
			this->btnDelete->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnDelete->Location = System::Drawing::Point(1043, 506);
			this->btnDelete->Margin = System::Windows::Forms::Padding(4);
			this->btnDelete->Name = L"btnDelete";
			this->btnDelete->Size = System::Drawing::Size(196, 97);
			this->btnDelete->TabIndex = 20;
			this->btnDelete->Text = L"Delete";
			this->btnDelete->UseVisualStyleBackColor = false;
			this->btnDelete->Click += gcnew System::EventHandler(this, &DeleteDriver::btnDelete_Click);
			// 
			// panelDriverInfo
			// 
			...
			this->panelDriverInfo->Location = System::Drawing::Point(38, 177);
			this->panelDriverInfo->Margin = System::Windows::Forms::Padding(4);
			this->panelDriverInfo->Name = L"panelDriverInfo";
			this->panelDriverInfo->Size = System::Drawing::Size(595, 307);
			...
			this->tbPhoneNo->ReadOnly = true;
			this->tbPhoneNo->Size = System::Drawing::Size(358, 22);
			...
			this->tbCNIC->Size = System::Drawing::Size(358, 22);
			...
			this->tbName->Size = System::Drawing::Size(358, 22);
			...
			this->panelAddDriver2->Location = System::Drawing::Point(26, 84);
			this->panelAddDriver2->Margin = System::Windows::Forms::Padding(4);
			this->panelAddDriver2->Name = L"panelAddDriver2";
			this->panelAddDriver2->Size = System::Drawing::Size(1213, 414);
			...
			this->panelDriverRef->Location = System::Drawing::Point(615, 93);
			this->panelDriverRef->Margin = System::Windows::Forms::Padding(4);
			this->panelDriverRef->Name = L"panelDriverRef";
			this->panelDriverRef->Size = System::Drawing::Size(589, 142);
			...
			this->panelDriverRef2->Location = System::Drawing::Point(615, 243);
			this->panelDriverRef2->Margin = System::Windows::Forms::Padding(4);
			this->panelDriverRef2->Name = L"panelDriverRef2";
			this->panelDriverRef2->Size = System::Drawing::Size(589, 157);
			...
			this->tbRef2PhoneNo->ReadOnly = true;
			...
			this->panelsearch->Location = System::Drawing::Point(4, 5);
			this->panelsearch->Margin = System::Windows::Forms::Padding(4);
			this->panelsearch->Name = L"panelsearch";
			this->panelsearch->Size = System::Drawing::Size(1202, 80);
			...
			this->lbSearchCNIC->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lbSearchCNIC->Location = System::Drawing::Point(32, 29);
			...
			this->cbCNIC->Location = System::Drawing::Point(189, 22);
			...
			this->cbCNIC->SelectedIndexChanged += gcnew System::EventHandler(this, &DeleteDriver::cbCNIC_SelectedIndexChanged);
			// 
			// DeleteDriver
			// 
			...
			this->Name = L"DeleteDriver";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Delete Driver";
			this->Load += gcnew System::EventHandler(this, &DeleteDriver::DeleteDriver_Load);
...
#pragma endregion
	...
	private: System::Void DeleteDriver_Load(System::Object^ sender, System::EventArgs^ e) {
		try {
			String^ filePath = "Drivers\\Drivers.txt";
			if (File::Exists(filePath)) {
				StreamReader^ reader = gcnew StreamReader(filePath);
	...
	private: System::Void btnDelete_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		System::Windows::Forms::DialogResult result = MessageBox::Show("Are you sure you want to delete Driver from database?",
		...
		if (result == System::Windows::Forms::DialogResult::Yes) {
			...
			try {
				...
				if (File::Exists(filePathRead)) {
					...
					MessageBox::Show("Driver was successfully deleted from the database.",
